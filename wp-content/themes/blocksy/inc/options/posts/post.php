						...
						'custom_sidebar' => [
							...
							'inner-options' => [
								...
								blocksy_rand_md5() => [
									'type' => 'ct-condition',
									'condition' => [
										'single_blog_post_structure' => 'type-1 | type-2'
									],
									'options' => $opt
								]
						...
						blocksy_rand_md5() => [
							...
							'options' => [
								...
								'related_label_wrapper' => [
									'label' => __( 'Block Title Tag', 'blocksy' ),
									'type' => 'ct-select',
									'value' => 'h3',
									'view' => 'text',
									'design' => 'inline',
								...
								blocksy_rand_md5() => [
									'type' => 'ct-condition',
									'condition' => [ 'related_structure' => 'narrow' ],
									'options' => [
										'relatedNarrowWidth' => [
						...
						blocksy_rand_md5() => [
							...
							'options' => [
								...
								'relatedPostsLabelColor' => [
									'label' => __( 'Block Title Font Color', 'blocksy' ),
									'type'  => 'ct-color-picker',
									'design' => 'inline',
									'setting' => [ 'transport' => 'postMessage' ],
